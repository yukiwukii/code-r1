...
CODER1_EXEC = os.environ.get("CODER1_EXEC", "singularity")

if CODER1_EXEC == "docker":
    from .docker_exec import code_exec_docker
    code_exec = code_exec_docker
elif CODER1_EXEC == "singularity":
    from .singularity_exec import code_exec_singularity
    code_exec = code_exec_singularity
